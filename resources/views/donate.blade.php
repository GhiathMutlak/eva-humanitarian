...
<html lang="en">
   ...
   <body data-spy="scroll" data-target="#navbarCodeply" data-offset="70">
      ...
      <!-- ========== Header Nav End ========== -->
      <!-- ========== Page Header Start ========== -->
      <section id="page-header" class="p-150px-t p-80px-b sm-p-100px-t sm-p-40px-b parallax overlay overlay-5" style="background-image:url(img/bg/helping-hands.jpg)">
        <div class="container">
          <div class="row">
            <div class="col text-center">
                <h2 class="white-text">Donate</h2>
      ...
      <section id="donate-full" class="p-80px-tb white-bg">
        <div class="container">
          <div class="row">
            ...
            <div class="row">
            <div class="col-sm-6 p-30px">
              <h3>Donate for helpless</h3>
              ...
              <div class="progress-bars m-35px-b">
                <P><b>Total raised:</b></P>
                  <div class="progress">
                     <div class="progress-bar" data-value="90" style="width: 90%;"><span>90%</span></div>
                  </div>
               </div>
               <footer class="content-footer m-35px-b">
            ...
            <div class="col-sm-6">
              <div class="diffuse-shadow p-45px sm-p-25px donate-form-wrap">
                ...
                <form class="m-30px-t">
                   ...
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="donorEmail" placeholder="Enter your email">
                   </div>
                   <div class="form-group">
                   ...
                   <a class="btn btn-default btn-small" href="#">Donate now</a>
                </form>
             </div>
            </div>
          </div>
